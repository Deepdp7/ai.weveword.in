...
import { Upload, FileText, Loader2, Download, CheckCircle2, ArrowLeft, AlertCircle } from 'lucide-react';
...
export default function GenericConverter() {
  ...
  const handleConvert = async () => {
    ...
    try {
      const { data } = await axios.post(`${API}/pdf/${toolKey}`, formData, {
          ...
          {!result ? (
            ...
            <div className="text-center py-8 space-y-6">
              ...
              <div>
                ...
                <p className="text-gray-500">Your file has been converted and saved to your library.</p>
              </div>
