    ...
    <div className="max-w-7xl mx-auto py-8">
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-gray-500 mt-1">All your generated files in one secure place.</p>
        </div>
      ...
      <div className="flex gap-8">
        ...
        <div className="flex-1">
          ...
          <div className="flex gap-4 mb-6">
            ...
            <button
              onClick={fetchFiles}
              className="px-4 py-3 bg-white border border-gray-200 rounded-xl flex items-center gap-2 text-gray-600 hover:bg-gray-50 font-medium transition-colors"
            >
              <RefreshCw className={`w-5 h-5 ${loading ? 'animate-spin' : ''}`} />
            </button>
            <label className="px-4 py-3 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl flex items-center gap-2 font-medium cursor-pointer transition-colors">
